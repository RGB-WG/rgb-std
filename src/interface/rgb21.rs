...
pub const LIB_ID_RGB21: &str =
    "urn:ubideco:stl:7ELkK9QsXfCJ4M8gdc4jGGSA6Ngb2q2443WWvsA5uxLV#topic-premium-austria";
...
impl IfaceWrapper for Rgb21 {
    ...
    const IFACE_ID: IfaceId = IfaceId::from_array([
        0x94, 0x19, 0x6d, 0xf1, 0xce, 0xde, 0x84, 0x77, 0x96, 0xb9, 0x53, 0x60, 0xfa, 0x50, 0xb3,
        0x32, 0xb6, 0xff, 0xe7, 0x8f, 0x5b, 0x41, 0x8e, 0xf2, 0x77, 0xd4, 0xc3, 0xbe, 0x47, 0xba,
        0x69, 0xca,
    ]);
}
